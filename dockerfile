...
# Copia la clave pública (no sensible) dentro del contenedor
COPY certs/public.pem /app/certs/public.pem

# Asegura permisos de lectura a la clave pública (opcional pero buena práctica)
RUN chmod 644 /app/certs/public.pem
